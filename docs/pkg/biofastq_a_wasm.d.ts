 ...
 */
export function analyze(data: Uint8Array, filename: string, timestamp: string, elapsed_ms: number): string;
...
export interface InitOutput {
    ...
    readonly analyze: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
