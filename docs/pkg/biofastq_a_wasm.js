/* @ts-self-types="./biofastq_a_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function analyze(data, filename, timestamp, elapsed_ms) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.analyze(ptr0, len0, ptr1, len1, ptr2, len2, elapsed_ms);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('biofastq_a_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
