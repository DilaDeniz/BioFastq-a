...
pub fn generate_html(f: &FileStats, timestamp: &str, elapsed_ms: f64) -> String {
    ...
    html.push_str("<span>Tool version: 2.3.0 (Wasm)</span>\n");
    ...
    html.push_str("<div class=\"footer\">Generated by <strong>BioFastq-A v2.3.0 (WebAssembly)</strong> &mdash; your sequencing data never left your browser.</div>\n");
